...
% TITLE
%------------------------------------------------------------------------------
\title{Filo-Priori: A Phylogenetic Approach to Test Case Prioritization}
...
The \filopriori{} architecture is a hybrid system that
...
\begin{equation}
    h_{fused} = \text{CrossAttn}(h_{semantic}, h_{combined})
\end{equation}
