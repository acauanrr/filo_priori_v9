...
our hypothesis that modeling test case relationships through a multi-edge
...
(2 layers, 4 heads). This suggests that the test relationships in
...
methods reported in recent surveys~\cite{hasnain2023systematic}. However, direct
