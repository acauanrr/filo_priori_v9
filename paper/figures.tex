...
(GAT) provides the largest contribution (+17.0\%), followed by Structural
Stream (+5.3\%), Focal Loss (+4.6\%), and Class Weighting (+3.5\%).
The dual-stream architecture combines semantic and structural information.}
\label{fig:ablation}
\end{figure}
