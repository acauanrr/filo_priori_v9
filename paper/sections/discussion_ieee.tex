...
The ablation shows that Focal Loss contributes +4.6\% improvement over standard
cross-entropy, and additional class weighting contributes +3.5\%. This validates
our hypothesis that proper handling of class imbalance is critical for TCP.
