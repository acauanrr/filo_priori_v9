...
\textbf{Key Findings:}
\begin{itemize}
    \item Filo-Priori achieves a mean APFD of \textbf{0.6413} (95\% CI: [0.612, 0.672])
    \item This represents a \textbf{14.6\%} improvement over Random ordering (APFD = 0.5596)
    \item The improvement is statistically significant ($p < 0.001$, Wilcoxon signed-rank test)
    \item Filo-Priori outperforms the strongest baseline FailureRate (0.6289) by \textbf{+2.0\%}
