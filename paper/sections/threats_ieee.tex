...
\textbf{Single Dataset}: Our evaluation uses one industrial dataset from a
commercial project. While the dataset is substantial (52,102 executions,
2,347 test cases), results may not generalize to all software projects.
We plan to evaluate on additional datasets in future work.
